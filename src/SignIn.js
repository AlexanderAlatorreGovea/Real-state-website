            ...
            <div className='SignIn'>
                ...
                <div className='sign-in-and-sign-up'>
                    <div className='sign-in'>
                        ...
                        <form onSubmit={() => { this.handleSubmit(); this.handleFormSubmit(); }} name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field">
                            <Form
                                name='email'
                                type='email'
                    ...
                    <div className='sign-up'>
                        ...
                        <form className='sign-up-form' onSubmit={() => { this.handleSubmit(); this.handleFormSubmit(); }} name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field">
                            <Form
                                type='text'
                                value='name'
                                name='displayName'
