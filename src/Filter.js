  ...
  cities = () => {
    if (this.props.globalState.populateFormsData.cities != undefined) {
      ...
      return cities.map((item) => {
        return (
          <option id="option" key={item} value={item}>
            {item}
          </option>
        );
      });
    ...
    return (
      <div id="filter">
        <div className="inside">
          ...
          <select
            name="city"
            className="neighborhood filters"
            onChange={this.props.change}
          >
            <option id="option" className="" value="All">
              All
            </option>
            {this.cities()}
          </select>
          ...
          <select
            name="homeType"
            className="homeType  filters"
            onChange={this.props.change}
          >
            <option id="option" value="All" className="">
              All Homes
            </option>
            {this.homeTypes()}
          </select>
