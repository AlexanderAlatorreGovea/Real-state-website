        ...
        <div className="about-us">
                ...
                <div className="contact-form">
                    ...
                    <div className="first-container">
                        <form id="contact" action="#" method="post">
                            ...
                            <span className="required-fields">All fields marked (<strong style={{ color: 'red' }}>*</strong>) are required</span>
            ...
            <footer>
                ...
                <div className="all-rights">
                    <h4 style={{ letterSpacing: '1px', color: '#808080'}}>&copy; Alexander Govea Ltd. All Rights Reserved</h4>
                    <strong style={{ letterSpacing: '1px'}}>Privacy Policy. Contact. Work for us</strong>
                </div>
            </footer>
        </div>
    ) 
